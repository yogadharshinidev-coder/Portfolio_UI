  ...
  <section id="education" className="section" style={{ background:'#fff' }}>
    <div className="wrap">
      ...
      <div className="reveal-left" style={{
        ...
        {/* Top accent */}
        <div style={{ height:4, background:'linear-gradient(90deg,var(--navy),var(--blue),var(--teal))' }} />

        <div style={{ padding: 'clamp(20px, 5vw, 36px) clamp(16px, 5vw, 40px)', display:'flex', gap:32, alignItems:'flex-start', flexWrap:'wrap' }}>
          ...
          <div style={{
            ...
            <HiAcademicCap size={32} style={{ color:'#ffffff' }} />
          </div>
          ...
          <div style={{ flex:1, minWidth:260 }}>
            ...
            <h3 style={{
              ...
              fontWeight:900, fontSize:22, color:'var(--navy)', marginBottom:4,
            }}>
              Bachelor of Commerce (B.COM)
            </h3>
            <p style={{ fontSize:15, fontWeight:700, color:'var(--blue)', marginBottom:14 }}>
            ...
            <div style={{ marginBottom:20 }}>
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:8 }}>
                ...
                <span style={{ fontSize:13, fontWeight:900, color:'var(--navy)' }}>75%</span>
              </div>
      ...
      <div className="reveal-left sd-1" style={{
        ...
        {/* Teal accent bar */}
        <div style={{ height: 4, background: 'linear-gradient(90deg,var(--teal),var(--teal-mid))' }} />

        <div style={{ padding: 'clamp(20px, 5vw, 28px) clamp(16px, 5vw, 40px)', display: 'flex', gap: 28, alignItems: 'flex-start', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: 240 }}>
            ...
            <h3 style={{
              fontFamily: 'Outfit,sans-serif',
              fontWeight: 900, fontSize: 19, color: 'var(--navy)', marginBottom: 4,
            }}>
              ASP.NET Core with C#
            </h3>
            <p style={{ fontSize: 14, fontWeight: 700, color: 'var(--teal)', marginBottom: 12 }}>
              C-Cube Technology
            </p>
